"""
Django settings for CircleReview project.
...
ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS=["https://circlereview-mullaahmed-aufj.live.cohesive.so"]
...
ROOT_URLCONF = 'CircleReview.urls'
...
WSGI_APPLICATION = 'CircleReview.wsgi.application'
